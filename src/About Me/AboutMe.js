...
export default function AboutMe() {
    return(
        <div id="aboutMee" className='my-8 flex flex-col py-4' style={{marginInline:'auto',width:'80%'}}>

            <div className='flex flex-col text-center'>
                <span className=' font-extrabold text-6xl underline tracking-wider'> &emsp;About Me&emsp;</span>
